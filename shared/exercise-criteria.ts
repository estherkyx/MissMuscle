...
export const exerciseCriteria: Record<ExerciseId, readonly ExerciseCriterion[]> = {
  ...
  leg_extension: [
    ...
    { id: 'full_extension', title: 'Full extension', expected: 'Straighten the knees fully at the top of the rep without forcing them beyond straight.', deviation: 'The knees remain clearly bent at the visible top of a repetition before the legs lower again.', visibility: 'Hip, knee and ankle visible from a comparable side view. Both complete and shortened-rep findings need at least three ordered moments showing the lift, furthest extension and return. Judge visible hip-knee-ankle alignment at the turnaround; smooth movement alone does not establish full extension. A mid-rep image or an unseen top is insufficient; do not infer exact knee angles or joint locking.', cue: 'Finish straightening your legs under control before lowering, without forcing your knees past straight.' },
  ...
  dumbbell_front_squat: [
    ...
    { id: 'squat_depth', title: 'Squat depth', expected: 'For the full-rep reference, lower until the thighs are approximately parallel to the floor, within a range you can control.', deviation: 'The rep clearly reverses while the thighs remain well above the reference depth.', visibility: 'Hips, knees and floor orientation visible from a comparable view. A frontal view can establish a clearly shallow turnaround when hips stay substantially higher than the knees; a foreshortened or obscured hip/knee relationship is insufficient. Both adequate-depth and shortened-rep findings need at least three ordered moments showing descent, the actual deepest position and ascent; standing afterward does not establish adequate depth. Do not infer depth from one mid-rep frame or an exact knee angle; missing turnaround evidence is unclear.', cue: 'Work toward the reference depth while keeping your heels down and your movement controlled; do not force a deeper position.' },
