import { curlSources } from '../../../shared/curl-reference';
...
export const EXERCISES: ExerciseReference[] = [
  {
    ...
    summary: 'Steady upper arm. Aligned wrist. Controlled movement.',
    notes: [
    ...
    ], sources: [{ ...curlSources.mayo, title: 'Mayo Clinic · Watch the dumbbell curl video' }, curlSources.ace, curlSources.anatomy],
  },
  {
    ...
    notes: [
      { title: 'Set up the seat', text: 'Secure your thighs under the pad and take an overhand grip. Brace your trunk with a small, comfortable backward lean and keep your head aligned with your spine. The pad should help keep you seated as you pull.' },
  ...
  },
  {
    ...
    notes: [
      ...
      { title: 'Control both directions', text: 'Extend toward a comfortable straight position without forcefully locking the knees, then lower steadily. Maintain the same seated position throughout the return. Aim for a smooth transition into the next repetition instead of letting the weight stack slam down.' },
    ],
  ...
  },
  {
    ...
    notes: [
      ...
      { title: 'Lower together', text: 'Bend your hips and knees together. Keep your feet grounded and knees following the direction of your toes, using a depth you can control. Let the hips move back and down while keeping the chest lifted; do not force a deeper position by rounding your back.' },
      { title: 'Stand tall', text: 'Push through your feet to straighten your hips and knees. Keep the weights close rather than letting them pull your torso forward. Finish in a balanced standing position before starting the next repetition.' },
    ],
    sources: [{ title: 'NASM · Dumbbell front squat guide & video', url: 'https://www.nasm.org/resource-center/exercise-library/dumbbell-front-squat' }],
  },
];
