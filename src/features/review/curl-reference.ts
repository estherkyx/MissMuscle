// Person A's proposed, browser-safe reference handoff. Shared contract v1 is unchanged.
...
export const curlReference = {
  ...
  criteria: [
    ...
    { id: 'steady_torso', title: 'Steady torso', expected: 'Keep the torso steady through the curl.', deviation: 'Repeated rocking or backward lean during lifting.', visibility: 'Compare torso and hips across multiple phases; camera motion is not body motion.', cue: 'Keep your torso steady as the weight rises.', sources: ['ace'] },
